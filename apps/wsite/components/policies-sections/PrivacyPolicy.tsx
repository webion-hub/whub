...
export default function PrivacyPolicy() {
  return (
    <Paragraph title="Privacy Policy">
      ...
      <p>
        At Webion, accessible from webion.it, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Webion and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in Webion. This policy is not applicable to any
      ...
      <h2>Log Files</h2>
      <p>
        Webion follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Webion uses &apos;cookies&apos;. These cookies
      ...
      <p>
        ...
        advertising partners of Webion.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Webion, which are sent directly
      ...
      <p>
        Note that Webion has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Webion&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Webion does not knowingly collect any Personal Identifiable Information
